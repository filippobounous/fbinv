...
# File paths
TRANSACTION_PATH: str | None = os.getenv("INVESTMENT_TRANSACTION_PATH")
TRANSACTION_SHEET_NAME: str | None = os.getenv("INVESTMENT_TRANSACTION_SHEET_NAME")
DEFAULT_NAME: str | None = os.getenv("INVESTMENT_DEFAULT_NAME")
BASE_PATH: str | None = os.getenv("INVESTMENT_BASE_PATH")

REQUIRED_ENV_VARS: dict[str, str | None] = {
    "INVESTMENT_TRANSACTION_PATH": TRANSACTION_PATH,
    "INVESTMENT_TRANSACTION_SHEET_NAME": TRANSACTION_SHEET_NAME,
    "INVESTMENT_BASE_PATH": BASE_PATH,
    "INVESTMENT_DEFAULT_NAME": DEFAULT_NAME,
}
