"""Realised volatility calculations for price series."""
...
class RealisedVolatilityCalculator:
    """Compute realised volatility metrics."""
    def __init__(
            self,
    ...
    def registry(self) -> Dict[str, Callable[[pd.DataFrame, int], pd.Series]]:
        """Mapping of model names to implementation methods."""
    ...
    def calculate(self, df: pd.DataFrame) -> pd.DataFrame:
        """Return realised volatility for each configured model and window."""
    ...
    def _gk_yang_zhang(self, df: pd.DataFrame, rv_win_size: int) -> pd.Series:
        """Combined Garman-Klass and Yang-Zhang estimator."""
